...
- page_plan_and_act：由 LLM 根据当前页面与子目标决定并执行「一步」动作。传入 goal（如「点击查询按钮」「填写出发地」）。适合复杂页面（如 12306、登录页）：page_goto -> page_wait(5~8) -> page_plan_and_act(子目标1) -> page_plan_and_act(子目标2) -> ...
