...
# TaskOutput.messages / LiteLLM 请求体 JSON 上限（略大于单条 completion）
CREWAI_TRACE_MESSAGES_JSON_MAX = 96000
CREWAI_TRACE_LLM_KWARGS_JSON_MAX = 96000
